...
struct RCC
{
  ...
  struct PLLCFGR : public RegisterBase<0x40023804, 32, ReadWriteMode>
  {
    ...
    using PLLP1 = RCC_PLLCFGR_PLLP_Values<RCC::PLLCFGR, 17, 2, ReadWriteMode, RCCPLLCFGRBase> ;
    
    using PLLN0 = RCC_PLLCFGR_PLLN_Values<RCC::PLLCFGR, 6, 9, ReadWriteMode, RCCPLLCFGRBase> ;
    using PLLN1 = RCC_PLLCFGR_PLLN_Values<RCC::PLLCFGR, 7, 9, ReadWriteMode, RCCPLLCFGRBase> ;
    using PLLN2 = RCC_PLLCFGR_PLLN_Values<RCC::PLLCFGR, 8, 9, ReadWriteMode, RCCPLLCFGRBase> ;
    using PLLN3 = RCC_PLLCFGR_PLLN_Values<RCC::PLLCFGR, 9, 9, ReadWriteMode, RCCPLLCFGRBase> ;
    using PLLN4 = RCC_PLLCFGR_PLLN_Values<RCC::PLLCFGR, 10, 9, ReadWriteMode, RCCPLLCFGRBase> ;
    using PLLN5 = RCC_PLLCFGR_PLLN_Values<RCC::PLLCFGR, 11, 9, ReadWriteMode, RCCPLLCFGRBase> ;
    using PLLN6 = RCC_PLLCFGR_PLLN_Values<RCC::PLLCFGR, 12, 9, ReadWriteMode, RCCPLLCFGRBase> ;
    using PLLN7 = RCC_PLLCFGR_PLLN_Values<RCC::PLLCFGR, 13, 9, ReadWriteMode, RCCPLLCFGRBase> ;
    using PLLN8 = RCC_PLLCFGR_PLLN_Values<RCC::PLLCFGR, 14, 9, ReadWriteMode, RCCPLLCFGRBase> ;
    
    using PLLM0 = RCC_PLLCFGR_PLLM_Values<RCC::PLLCFGR, 0, 5, ReadWriteMode, RCCPLLCFGRBase> ;
    using PLLM1 = RCC_PLLCFGR_PLLM_Values<RCC::PLLCFGR, 1, 5, ReadWriteMode, RCCPLLCFGRBase> ;
    using PLLM2 = RCC_PLLCFGR_PLLM_Values<RCC::PLLCFGR, 2, 5, ReadWriteMode, RCCPLLCFGRBase> ;
    using PLLM3 = RCC_PLLCFGR_PLLM_Values<RCC::PLLCFGR, 3, 5, ReadWriteMode, RCCPLLCFGRBase> ;
    using PLLM4 = RCC_PLLCFGR_PLLM_Values<RCC::PLLCFGR, 4, 5, ReadWriteMode, RCCPLLCFGRBase> ;
    using PLLM5 = RCC_PLLCFGR_PLLM_Values<RCC::PLLCFGR, 5, 5, ReadWriteMode, RCCPLLCFGRBase> ;
