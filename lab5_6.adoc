...
extern "C" {
 int __low_level_init(void)
 {
  RCC::CR::HSION::On::Set(); // Установление бита HSION в регистре CR
  while (RCC::CR::HSIRDY::NotReady::IsSet()) // Проверка готовности
  {
  
  }
 
  RCC::CFGR::SW::Hsi::Set(); // Выбор HSI в качестве источника тактирования
  while (!RCC::CFGR::SWS::Hsi::IsSet()) // Проверка готовности
  {
...
[source, cpp]
----
std::uint32_t SystemCoreClock = 8'000'000U; // Указание тактовой частоты

extern "C" {
 int __low_level_init(void)
 {
  RCC::CR::HSION::Off::Set(); // Сброс бита HSION в регистре CR
  RCC::CR::HSEON::On::Set(); // Установление бита HSEON в регистре CR
  while (RCC::CR::HSERDY::NotReady::IsSet()) // Проверка готовности
  {
  
  }
 
  RCC::CFGR::SW::Hse::Set(); // Выбор HSI в качестве источника тактирования
  while (!RCC::CFGR::SWS::Hse::IsSet()) // Проверка готовности
  {
...
extern "C" {
  ...
  int __low_level_init(void)
  {
    ...
    RCC::PLLCFGR::PLLN0::Set(1U);
    RCC::PLLCFGR::PLLN1::Set(1U);
    RCC::PLLCFGR::PLLN2::Set(1U);
    RCC::PLLCFGR::PLLN3::Set(1U);
    RCC::PLLCFGR::PLLN4::Set(0U);
    RCC::PLLCFGR::PLLN5::Set(0U);
    RCC::PLLCFGR::PLLN6::Set(0U);
    RCC::PLLCFGR::PLLN7::Set(1U);
    RCC::PLLCFGR::PLLN8::Set(0U);
    
    // Установка битов PLLP
    RCC::PLLCFGR::PLLP0::Set(0U);
    RCC::PLLCFGR::PLLP1::Set(0U);
    
    // Установка битов PLLM
    RCC::PLLCFGR::PLLM0::Set(0U);
    RCC::PLLCFGR::PLLM1::Set(1U);
    RCC::PLLCFGR::PLLM2::Set(0U);
    RCC::PLLCFGR::PLLM3::Set(1U);
    RCC::PLLCFGR::PLLM4::Set(0U);
    RCC::PLLCFGR::PLLM5::Set(1U);
    
    RCC::CR::HSION::Off::Set(); // Выключение HSI
...
Таким образом, была установлена тактовая частота 13,666 МГц.
